...
const Sidebar = ({ isOpen, toggleSideBar }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar container */}
      <div
        className={`fixed inset-y-0 left-0 w-[250px] bg-gradient-to-br from-[#FFA764] to-[#FF7B50] p-6 shadow-xl transition-transform transform z-20 flex flex-col justify-between ${
